...
from shadowsocksr_cli.shadowsocks import encrypt, obfs, eventloop, lru_cache, common, shell
from shadowsocksr_cli.shadowsocks.common import pre_parse_header, parse_header, pack_addr, logging
